...
libro (Cyrius library, single-file compilation)
  ...
  ├── SQL persistence via patra (v1.14.3 bundled)
...
# Run tests (795 assertions default / 807 with -D LIBRO_TPM, 0 failures expected)
./build/libro
...
```
src/main.cyr             Entry point + 795/807 inline tests (default / LIBRO_TPM)
